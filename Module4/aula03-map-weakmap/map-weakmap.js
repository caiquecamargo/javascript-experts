...
myMap.set(onlyRefenceWorks, { name: 'Caique de Camargo' })

assert.deepStrictEqual(myMap.get({ id: 1 }), undefined)
assert.deepStrictEqual(myMap.get(onlyRefenceWorks), { name: "Caique de Camargo" })
...
// mais leve e previne leak de memoria, pq depois que as instancias saem da memoria, tudo é limpo
